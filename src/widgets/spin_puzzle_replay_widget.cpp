    ...
    , m_recorder(recorder)
{
    ...
    connect(m_timer, &QTimer::timeout, this, [this] {
        if (!this->m_recorder.isEnd()) {
            ...
            this->m_spinPuzzleWidget->set_game(this->m_recorder.current_time() / 1000, m_game);
            this->update();
        } else {
            this->m_timer->stop();
            this->m_play->setText("▶");
...
SpinPuzzleReplayWidget::setup_layout()
{
    ...
    m_spinPuzzleWidget = new SpinPuzzleWidget(m_win_width, m_win_heigth, SpinPuzzleWidget::TypePuzzle::SHOW_REPLAY, this);
